...
class CashierController extends Controller
{
    ...
    private function getSaleDetails($sale_id)
    {
        ...
        foreach ($saleDetails as $saleDetail) {
            ...
            $decreaseButton = '<button class="btn btn-decrease-quantity text-danger" disabled>-</button>';
            if ($saleDetail->quantity > 1) {
                $decreaseButton = '<button data-id="' . $saleDetail->id . '" class="btn btn-decrease-quantity text-danger">-</button>';
            }
            ...
            <tr>
                ...
                <td>' . $decreaseButton. ' '. $saleDetail->quantity . '<button data-id="' . $saleDetail->id . '" class="btn btn-increase-quantity text-success">+</button></td>
